...
class VertBlurCompute : public BaseShader
{
public:
	VertBlurCompute(ID3D11Device* device, HWND hwnd, int screen_width, int screen_height);
	~VertBlurCompute();

	void setShaderParameters(ID3D11DeviceContext* device_context, ID3D11ShaderResourceView* buffer_to_blur);
