...
{
	//InputPatch<InputType, 3> patch -> the patch has 3 control points
	//uint pointId : SV_OutputControlPointID -> Index of the control point operated on on this call
	//uint patchId : SV_PrimitiveID -> Per-primitive identifier automatically generated by the runtime (Microsoft Docs) -> the primitive is our current patch
