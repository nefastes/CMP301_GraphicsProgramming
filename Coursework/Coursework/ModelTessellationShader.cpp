...
ModelTessellationShader::ModelTessellationShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	initShader(L"tessellation_model_vs.cso", L"tessellation_model_fodd_hs.cso", L"tessellation_model_ds.cso", L"tessellation_model_ps.cso");
}

ModelTessellationShader::~ModelTessellationShader()
{
	if (sampleState)
	{
		sampleState->Release();
...
void ModelTessellationShader::initShader(const wchar_t* vsFilename, const wchar_t* psFilename)
{
...
void ModelTessellationShader::initShader(const wchar_t* vsFilename, const wchar_t* hsFilename, const wchar_t* dsFilename, const wchar_t* psFilename)
{
